...
function SubmitProvenElementsResultContainer(props: { state: SubmitState }) {
  return (
...
function SubmitProvenElemenStepCountAndProof(props: {
...
function SubmitProvenElementsForm(props: {
  element: () => DataProvenEntry;
  setElement: Setter<DataProvenEntry>;
}) {
  return (
